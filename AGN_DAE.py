...
if __name__ == '__main__':
    ...
    dae = Add_gauss_noise_DAE(784,300,0.01,0.1)
    batch_size = 128
    epochs = 10
    ...
    plt.imshow((mnist.train.images[4] + 0.1*np.random.normal(
            loc = 0,scale = 1,size = [784,])).reshape([28,28]))
    plt.imshow(dae.reconstruct(mnist.train.images[4].reshape([1,784])).reshape(28,28))    